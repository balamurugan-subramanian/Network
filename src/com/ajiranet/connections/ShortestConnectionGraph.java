...
public class ShortestConnectionGraph {
    ...
    static class Graph{
        ...
        public void getShotestDistances(int sourceVertex){
        ...
        public void printShortestPath(int sourceVertex, int [] key){
            System.out.println("Algorithm: (Adjacency Matrix)");
            for (int i = 0; i <vertices ; i++) {
    ...
    public static void main(String[] args) {
        ...
        graph.addConnection(4, 5, 6);
        graph.getShotestDistances(sourceVertex);
    }
}
